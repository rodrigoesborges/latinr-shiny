...
author: "<img src = 'img/logo.png' width = '30%'><br>Rodrigo Borges(Cursos Borges)"
...
.pull-left[
```{r, echo = FALSE}
knitr::include_graphics("https://cursos.borges.net.br/pluginfile.php/1/theme_moove/logo/1673799194/logocursosborges.png")
```
